...
extension Level {
    static func fetchReviewableCountInsideLevel(context: NSManagedObjectContext, level: Level, leitnerId: Int64) -> Int {
    ...
    static func fetchTotalCountInsideLevel(context: NSManagedObjectContext, level: Int16, leitnerId: Int64) -> Int {
        let req = Question.fetchRequest()
    ...
    static func fetchCompletedCount(context: NSManagedObjectContext, leitnerId: Int64) -> Int {
        let req = Question.fetchRequest()
    ...
    static func fetchFavCountInsideLevel(context: NSManagedObjectContext, level: Int16, leitnerId: Int64) -> Int {
        let req = Question.fetchRequest()
    ...
    static func hasAnyReviewable(context: NSManagedObjectContext, level: Level, leitnerId: Int64) -> Bool {
