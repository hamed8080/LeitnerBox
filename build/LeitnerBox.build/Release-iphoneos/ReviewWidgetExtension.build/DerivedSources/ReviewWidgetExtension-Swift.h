...
#ifndef REVIEWWIDGETEXTENSION_SWIFT_H
#define REVIEWWIDGETEXTENSION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ReviewWidgetExtension",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface Leitner (SWIFT_EXTENSION(ReviewWidgetExtension))
...
@interface Level (SWIFT_EXTENSION(ReviewWidgetExtension))
...
@interface Question (SWIFT_EXTENSION(ReviewWidgetExtension))
...
@interface Statistic (SWIFT_EXTENSION(ReviewWidgetExtension))
...
@interface Synonym (SWIFT_EXTENSION(ReviewWidgetExtension))
...
@interface Tag (SWIFT_EXTENSION(ReviewWidgetExtension))
- (void)addQuestionObject:(Question * _Nonnull)value;
- (void)removeQuestionObject:(Question * _Nonnull)value;
- (void)addQuestion:(NSSet * _Nonnull)values;
- (void)removeQuestion:(NSSet * _Nonnull)values;
